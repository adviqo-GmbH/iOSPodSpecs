#
#  Be sure to run `pod spec lint ReusableDataInput.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source = { :git => "https://github.com/adviqo-GmbH/iOSReusableDataInput.git", :tag => "#{s.version}" }
